<template>
  <a-layout>
    <a-descriptions title="个人信息" bordered size="default" style="background-color: white" layout="vertical">
      <a-descriptions-item :label="noLabel">{{userinfo.userno}}</a-descriptions-item>
